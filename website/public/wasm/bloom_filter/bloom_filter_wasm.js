/* @ts-self-types="./bloom_filter_wasm.d.ts" */
...
export class BloomFilter {
    ...
    check(item) {
        const ptr0 = passStringToWasm0(item, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.bloomfilter_check(this.__wbg_ptr, ptr0, len0);
        return ret !== 0;
    }
    /**
     * @returns {number}
     */
    get hash_count() {
        const ret = wasm.bloomfilter_hash_count(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @param {number} items_count
     * @param {number} fp_prob
     */
    constructor(items_count, fp_prob) {
        const ret = wasm.bloomfilter_new(items_count, fp_prob);
        this.__wbg_ptr = ret;
     ...
     */
    get size() {
        const ret = wasm.bloomfilter_size(this.__wbg_ptr);
        return ret >>> 0;
    }
}
 ...
 * @returns {string}
 */
export function run_reference_demo() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.run_reference_demo();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./bloom_filter_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('bloom_filter_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
