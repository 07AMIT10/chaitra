    ...
    <>
      ...
      >
        ...
        <div className="drishti-echo-banner__actions">
          <button
            type="button"
            data-analytics="echo-yes"
            onClick={() => {
              trackDrishti("echo-yes");
          ...
          <button
            type="button"
            data-analytics="echo-changed"
            onClick={() => {
              trackDrishti("echo-changed");
              onChanged(eligible.passId);
            }}
          >
            Changed
          </button>
          <button
            ...
            data-analytics="echo-dismiss"
            onClick={() => {
              trackDrishti("echo-dismiss");
              updatePass({ echoDismissed: true });
            }}
          >
            Dismiss
          </button>
